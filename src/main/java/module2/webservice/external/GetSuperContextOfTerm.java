...
@WebServlet(urlPatterns = "/GetSuperContextOfTerm", loadOnStartup = 1)

public class GetSuperContextOfTerm extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (!(request == null || request.isBlank())) {
            ...
            try {
                GenericModel4 topic = IoTTopicsMoreContextDAO.getSuperContextOfALternativeTopic(request);
